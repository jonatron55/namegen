...
use leptos::prelude::*;
use libnamegen::{
    config::{BuildGenerator, ConfigSourceType, GeneratorConfig, ParseError},
...
fn App() -> impl IntoView {
    ...
    let on_config_loaded = Callback::new(move |config: Result<GeneratorConfig, ParseError>| match config {
    ...
    view! {
        <div class="app">
            ...
            }} <Toolbar config on_config_loaded />
            <OutputPanel
